...
```math
\frac{\partial{C}}{\partial{W_{ij}}^{(n)}} = \frac{\partial{C}}{\partial{\hat{y_i}}} * \frac{\partial{\hat{y_{i}}}{\partial{z_{i}}^{(n)}}  * \frac{\partial{z_{i}}^{(n)}}{\partial{{W_{(ij)}}^{(n)}}}
```
```math
\frac{\partial{C.      }}{\partial{\hat{y_{i}}}}
